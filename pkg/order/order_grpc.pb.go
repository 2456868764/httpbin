...
type OrderManagementClient interface {
	SayHello(ctx context.Context, in *Hello, opts ...grpc.CallOption) (*wrapperspb.StringValue, error)
...
func (c *orderManagementClient) SayHello(ctx context.Context, in *Hello, opts ...grpc.CallOption) (*wrapperspb.StringValue, error) {
	out := new(wrapperspb.StringValue)
	err := c.cc.Invoke(ctx, "/order.OrderManagement/sayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderManagementServer interface {
	SayHello(context.Context, *Hello) (*wrapperspb.StringValue, error)
...
func (UnimplementedOrderManagementServer) SayHello(context.Context, *Hello) (*wrapperspb.StringValue, error) {
...
func _OrderManagement_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Hello)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderManagementServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/order.OrderManagement/sayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderManagementServer).SayHello(ctx, req.(*Hello))
	}
...
var OrderManagement_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "sayHello",
			Handler:    _OrderManagement_SayHello_Handler,
		},
		{
			MethodName: "addOrder",
